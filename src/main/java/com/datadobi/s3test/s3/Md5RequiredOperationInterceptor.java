...
public class Md5RequiredOperationInterceptor implements ExecutionInterceptor {
    ...
    public static ChecksumSpecs resolveChecksumSpecs(ExecutionAttributes executionAttributes) {
        ...
        if (httpChecksumTraitInOperation == null) {
            ...
            return ChecksumSpecs.builder().algorithmV2(DefaultChecksumAlgorithm.fromValue(requestAlgorithm)).headerName(checksumHeaderName)
                    .responseValidationAlgorithmsV2(httpChecksumTraitInOperation.responseAlgorithmsV2()).isValidationEnabled(hasRequestValidation)
                    ...
                    .requestAlgorithmHeader(httpChecksumTraitInOperation.requestAlgorithmHeader()).build();
        }
    }
}